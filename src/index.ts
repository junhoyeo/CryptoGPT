...
export const run = async () => {
  ...
  const tools = [
    new DynamicTool({
      name: "eth.address",
      description:
        "call this to get your wallet address",
    ...
    new DynamicStructuredTool({
      name: "eth.send",
      description: "call this to send transactions with your wallet. props are {to,value,nonce,gasLimit,gasPrice,data,chainId}. Leave values blank if you dont need them(ex> you dont usually add nonce). This tool returns transaction hash after executing your transaction.",
      schema: z.object({
        to: z.string(),
